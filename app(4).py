...
with st.sidebar:
    ...
    """)
    st.divider()
    st.header("Official FAA Links & Worksheets")
    st.markdown(f"""
    **Main pages**
    - [All CACI Conditions (worksheets list)]({CACI_MAIN})
    - [Full AME Guide home]({AME_GUIDE})
    - [Disposition Tables index](https://www.faa.gov/ame_guide/dec_cons/disp)

    **High-use CACI worksheet PDFs**
    - [Asthma]({ASTHMA_CACI})
    ...
    **Other CACI conditions** (open the main CACI page and click the condition name for the current PDF):
    Arthritis, Bladder Cancer, Breast Cancer, Carotid/Vertebral Stenosis, CLL/SLL, Colon Cancer, Eosinophilic Esophagitis, Essential Tremor, Hepatitis C, Hypothyroidism, Low Testosterone, MASH/NASH, Mitral Valve Repair, PCOS, Primary Hemochromatosis, Prostate Cancer, Psoriasis, Renal Cancer, Retained Kidney Stone(s), Testicular Cancer, Weight Loss Management, C-ITP, etc.

    → [Open full CACI list]({CACI_MAIN})
    """)
    st.divider()
...
# ========== HELPER ==========
def show_result(decision, message, item60="", reference=""):
    if decision == "Issue":
    ...
    # Always show a verification reference
    if reference:
        st.markdown(f"**Verify on AME Guide:** {reference}")
    else:
        st.markdown(f"**Verify on AME Guide:** [Full AME Guide]({AME_GUIDE}) | [All CACI Conditions]({CACI_MAIN}) — confirm the specific disposition table or worksheet for this condition before final action.")
    ...
    if headache_type.startswith("Simple"):
        ...
        if mild == "Yes":
            show_result("Issue",
                ...
                reference=f"[Headache/Migraine disposition](https://www.faa.gov/ame_guide) | [CACI Migraine PDF]({MIGRAINE_CACI})")
        ...
        show_result("Defer",
            ...
            reference=f"[CACI Migraine PDF]({MIGRAINE_CACI}) | [Item 46 Neurologic](https://www.faa.gov/ame_guide)")
        ...
        if all(x == "Yes" for x in [c1,c2,c3,c4,c5,c6,c7,c8]):
            show_result("CACI Issue",
                ...
                reference=f"[CACI – Migraine PDF]({MIGRAINE_CACI}) | [All CACI Conditions]({CACI_MAIN})")
            ...
            show_result("Defer",
                ...
                reference=f"[CACI – Migraine PDF]({MIGRAINE_CACI})")
...
if "18.b" in selected:
    ...
    if "Single" in diz:
        show_result("Issue", "Single explained episode with full recovery may be issuable with good documentation.",
                    ...
                    reference="[AME Guide – Item 18.b / Neurologic disposition tables](https://www.faa.gov/ame_guide)")
...
if "18.c" in selected:
    ...
    if "Clearly explained" in unc:
        show_result("Defer", "Even explained unconsciousness often needs neurological review. Evaluate under head-injury / neurological protocols. When in doubt, defer.",
                    reference="[AME Guide – Item 18.c / Neurologic / Head injury protocols](https://www.faa.gov/ame_guide)")
        ...
        show_result("Defer", "Unexplained or recurrent loss of consciousness is almost always deferred.",
                    reference="[AME Guide – Item 18.c / Neurologic disposition tables](https://www.faa.gov/ame_guide)")
...
if "18.d" in selected:
    ...
    if "Simple refractive" in eye:
        show_result("Issue", "Meets visual standards with or without correction. Add corrective lens limitation if required.",
                    ...
                    reference="[Item 31–34 Eyes / Visual standards](https://www.faa.gov/ame_guide)")
        ...
        if all(x == "Yes" for x in [g1,g2,g3,g4,g5,g6,g7]):
            show_result("CACI Issue", "All CACI Glaucoma criteria appear met.",
                        ...
                        reference=f"[CACI – Glaucoma PDF]({GLAUCOMA_CACI}) | [Item 32 Ophthalmoscopic](https://www.faa.gov/ame_guide/app_process/exam_tech/item32/amd)")
            ...
            show_result("Defer", "One or more CACI Glaucoma criteria not met. Defer with full ophthalmology records.",
                        reference=f"[CACI – Glaucoma PDF]({GLAUCOMA_CACI})")
        ...
        show_result("Defer", "Significant eye pathology generally requires FAA decision. Obtain Form 8500-7 or specialist report.",
                    reference="[Item 31–34 Eyes disposition tables](https://www.faa.gov/ame_guide/app_process/exam_tech/item32/amd)")
...
if "18.e" in selected:
    ...
    if "Mild" in allg:
        show_result("Issue", "Mild controlled allergies are usually not disqualifying.",
                    ...
                    reference="[AME Guide – Item 18.e / Pharmaceuticals – Antihistamines](https://www.faa.gov/ame_guide)")
        ...
        show_result("Defer", "Severe or uncontrolled allergies, or use of sedating medications, may require deferral.",
                    reference="[AME Guide – Item 18.e / Do Not Issue medications](https://www.faa.gov/ame_guide)")
    ...
    if ast.startswith("A."):
        ...
        if interfere.startswith("Yes"):
            show_result("Issue", 
                ...
                reference=f"[Item 35 – Asthma disposition table](https://www.faa.gov/ame_guide/app_process/exam_tech/item35/amd/asthma) | [CACI Asthma PDF]({ASTHMA_CACI})")
        ...
        show_result("Defer", 
            ...
            reference=f"[Item 35 – Asthma disposition table](https://www.faa.gov/ame_guide/app_process/exam_tech/item35/amd/asthma)")
        ...
        if all(x == "Yes" for x in [a1, a2, a3, a4, a5, a6, a7, a8]):
            show_result("CACI Issue", 
                ...
                reference=f"[CACI – Asthma Worksheet PDF]({ASTHMA_CACI}) | [Item 35 Asthma](https://www.faa.gov/ame_guide/app_process/exam_tech/item35/amd/asthma)")
...
if "18.g" in selected:
    ...
    if "Significant" in heart:
        show_result("Defer", "Most significant cardiac conditions require initial FAA review (Defer). Follow-up may use AASI protocols if previously authorized.",
                    reference="[Item 36 Heart disposition tables](https://www.faa.gov/ame_guide) | [AASI protocols](https://www.faa.gov/ame_guide/special_iss/all_classes)")
        ...
        show_result("Defer", "Even apparently minor cardiac history is usually deferred on first presentation for FAA review. When in doubt, defer.",
                    reference="[Item 36 Heart disposition tables](https://www.faa.gov/ame_guide)")
    ...
    if bp.startswith("A."):
        ...
        if bp_ok == "Yes":
            show_result("Issue",
                ...
                reference=f"[Item 36 / 55 Hypertension](https://www.faa.gov/ame_guide/app_process/exam_tech/item36/amd/hypertension) | [CACI Hypertension PDF]({HYPERTENSION_CACI})")
        ...
        show_result("Defer",
            ...
            reference=f"[Item 36 Hypertension](https://www.faa.gov/ame_guide/app_process/exam_tech/item36/amd/hypertension)")
        ...
        if all(x == "Yes" for x in [h1, h2, h3, h4, h5]) and h6.startswith("Yes"):
            show_result("CACI Issue",
                ...
                reference=f"[CACI – Hypertension Worksheet PDF]({HYPERTENSION_CACI}) | [Item 36 Hypertension](https://www.faa.gov/ame_guide/app_process/exam_tech/item36/amd/hypertension)")
            ...
            show_result("Defer",
                ...
                reference=f"[CACI – Hypertension Worksheet PDF]({HYPERTENSION_CACI})")
    ...
    if "Prediabetes" in dia:
        ...
        if pre.startswith("Yes"):
            show_result("CACI Issue", "If the official CACI Prediabetes worksheet criteria are fully satisfied, you may issue. Keep documents on file.",
                        ...
                        reference=f"[CACI – Prediabetes PDF]({PREDIABETES_CACI}) | [All CACI]({CACI_MAIN})")
        ...
        show_result("Defer",
            ...
            reference="[AME Guide – Diabetes / Special Issuance protocols](https://www.faa.gov/ame_guide) → search Diabetes or AASI")
        ...
        show_result("Defer",
            ...
            reference="[AME Guide – Insulin / Diabetes protocols](https://www.faa.gov/ame_guide)")
    ...
    **Important:** Most significant psychiatric conditions require FAA review.  
    ...
    if ment.startswith("Mild, fully resolved"):
        ...
        show_result("Defer",
            ...
            reference="[Item 47 – Psychiatric Conditions / Antidepressant pathway](https://www.faa.gov/ame_guide) → search Antidepressant or Anxiety Depression")
...
if "18.n" in selected or "18.o" in selected:
    ...
    show_result("Defer", "Any history of substance dependence, recent abuse, or failed drug test almost always requires deferral and formal evaluation (frequently HIMS for professional pilots).",
                    reference="[AME Guide – Substance / HIMS](https://www.faa.gov/ame_guide) | [HIMS information](https://www.faa.gov/go/hims)")
...
if "18.p" in selected:
    ...
    show_result("Defer", "Any history of suicide attempt requires full psychiatric evaluation and FAA review.",
                    reference="[Item 47 Psychiatric Conditions](https://www.faa.gov/ame_guide)")
...
if "18.v" in selected:
    ...
    show_result("Defer", "Must be reported. Recent or multiple actions, or any suggestion of substance issues, usually require deferral and possible substance evaluation. Remind airman of 14 CFR 61.15 reporting requirements.",
                    reference="[AME Guide – Item 18.v / Substance](https://www.faa.gov/ame_guide) | 14 CFR 61.15")
