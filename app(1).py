...
if "18.a" in selected:
    ...
    **Official structure (approximate):**
    ...
    if headache_type.startswith("Simple"):
        ...
        st.markdown("**CACI – Migraine and Chronic Headache Worksheet (current published criteria) — ALL must be Yes:**")
...
if "18.k" in selected:
    ...
    **High-level guidance:**
    ...
    if "Prediabetes" in dia:
        st.info("Confirm the current CACI – Prediabetes worksheet on the FAA AME Guide. Typical requirements include recent labs, stability, and absence of progression to diabetes.")
